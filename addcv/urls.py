...
urlpatterns = [
     ...
     path('updateeducation/<int:education_id>', views.updateeducation,name='updateeducation'),
     path('deleteeducation/<int:education_id>', views.deleteeducation,name='deleteeducation'),
